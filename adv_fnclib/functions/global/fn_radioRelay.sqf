/*
ADV_fnclib_fnc_radioRelay - by Belbo (QA and approved by Nyaan)
...
in init.sqf:
[VEHICLE, west, 90] call ADV_fnclib_fnc_radioRelay;
or
[VEHICLE, west, 90] call compile preprocessFileLineNumbers "fn_radioRelay.sqf";
