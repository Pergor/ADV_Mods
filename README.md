...
adv_radioheadset: Adds action to lower or raise headset for radios with task force arrowhead radio. (Requires TFAR)

adv_retex: Adds vehicles with missing hidden textures (thanks to Stevenson!)

adv_rhs_faction_insurgents: Adds RHSAFRF insurgent faction to side east. (Requires RHSAFRF)
